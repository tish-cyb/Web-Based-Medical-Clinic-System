...
<body>
    ...
    <div class="chatbot-container" id="chatbotContainer">
        ...
        <div class="quick-actions">
            ...
            <button class="quick-action-btn" data-message="Change password">🔒 Password</button>
        ...
        <div class="chatbot-messages" id="chatbotMessages">
            <div class="message bot">
                ...
                <div class="message-content">
                    Hello! I can help you manage your profile and account settings. What do you need?
                </div>
            </div>
        </div>
        ...
        <div class="profile-section">
            ...
            <div class="section-content">
                ...
                <div class="profile-actions">
                    ...
                    <button class="btn-action btn-logout">
                        Logout
                    </button>
                </div>
            </div>
    ...
    <script>
        ...
        // Bot responses for profile page
        function getBotResponse(message) {
            ...
            if (lowerMessage.includes('edit') || lowerMessage.includes('update') || lowerMessage.includes('change info')) {
                ...
                return "You're enrolled in: Diploma in Information Technology, 3rd Year\n\nIf you need to update your program or year level, please contact the registrar's office.";
            } else if (lowerMessage.includes('hello') || lowerMessage.includes('hi')) {
                return "Hello! I'm here to help you manage your profile. What would you like to know?";
            } else if (lowerMessage.includes('help')) {
                return "I can help you with:\n• Editing profile information\n• Changing password\n• Updating emergency contact\n• Managing contact details\n• Account security\n\nWhat do you need help with?";
            } else {
                return "I can help you manage your profile settings, update your information, or answer questions about your account. What would you like to know?";
            }
        }
        ...
        logoutBtn.addEventListener('click', () => {
            ...
            if (confirm('Are you sure you want to logout?')) {
                // Redirect to logout.php (go up one folder level)
